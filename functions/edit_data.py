        ...
        if zipfile.is_zipfile(downloaded_file):
            with zipfile.ZipFile(downloaded_file, "r") as zip_ref:
                ...
                if str(selected_collection) == "EO:EUM:DAT:MSG:HRSEVIRI":
                    edit_seviri(logger=logger, filename=str(product), selected_folder=selected_folder)
                elif str(selected_collection) == "EO:EUM:DAT:0662":
                    edit_fci(logger=logger,filename=str(product), selected_folder=selected_folder)
